...
> 재고 동시성 제어부터 분산 락, 부하테스트까지 단계별로 성능을 개선하는 커머스 백엔드를 구현합니다.
...
| v0.2 | 상품 / 재고 / 주문 API | ✅ 완료 |
| v0.3 | 결제 연동 (Toss Payments) | 🔨 진행중 |
...
| v1.2 | k6 부하테스트 - DB 락 vs Redis 성능 비교 | ⬜ 예정 |
...
| 단계 | 내용 | 상태 |
|------|------|------|
| v2.2 | 선착순 쿠폰 발급 (Redis INCR 원자적 처리) | 🔭 목표 |
| v2.3 | 쿠폰 적용 주문 할인 로직 | 🔭 목표 |
